...
LOCALES.en = {
  ...
  ui: {
    ...
    youWin: '🏆 You Win!', youLose: 'Defeat', changePortrait: 'Change portrait', rolePartner: 'Partner', lastTrick: 'Last trick', dealerChip: 'Dealer', suggested: 'Suggested', roleOpponent: 'Opponent', roleRival: 'Rival', wins: 'Wins', close: 'Close', continue_: 'Continue',
...
LOCALES.es = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 ¡Ganaste!', youLose: 'Derrota', changePortrait: 'Cambiar retrato', rolePartner: 'Compañero', lastTrick: 'Última baza', dealerChip: 'Reparte', suggested: 'Sugerida', roleOpponent: 'Rival', roleRival: 'Rival', wins: 'Victorias', close: 'Cerrar', continue_: 'Continuar',
...
LOCALES.ar = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 فزت!', youLose: 'هزيمة', changePortrait: 'تغيير الصورة', rolePartner: 'شريك', lastTrick: 'آخر أكلة', dealerChip: 'الموزّع', suggested: 'مقترح', roleOpponent: 'خصم', roleRival: 'منافس', wins: 'انتصارات', close: 'إغلاق', continue_: 'متابعة',
...
LOCALES.zh = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 你赢了！', youLose: '失败', changePortrait: '更换头像', rolePartner: '搭档', lastTrick: '上一墩', dealerChip: '庄家', suggested: '建议', roleOpponent: '对手', roleRival: '对手', wins: '胜', close: '关闭', continue_: '继续',
