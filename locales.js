...
LOCALES.en = {
  ...
  ui: {
    ...
    youWin: '🏆 You Win!', youLose: 'Defeat', changePortrait: 'Change portrait', rolePartner: 'Partner', lastTrick: 'Last trick', dealerChip: 'Dealer', suggested: 'Suggested', houseRules: 'House Rules', hrNil: 'Nil', hrBlindNil: 'Blind Nil', hrBoard: 'Board of 4', hrJokers: 'Jokers & Deuces', hrFloor: 'Lose at {n}', hrNoFloor: 'No losing floor', ai_easy: 'Easy AI', ai_medium: 'Medium AI', ai_hard: 'Hard AI', feedback: '💬 Feedback', fxTrump: 'Trumped!', fxStreak: 'Streak', fxOvertrump: 'Over-trumped!', fxAceSpades: 'Ace of Spades!', fxBigJoker: 'Big Joker!', fxLittleJoker: 'Little Joker!', boardNote: 'Your team must bid at least {n}', roleOpponent: 'Opponent', roleRival: 'Rival', wins: 'Wins', close: 'Close', continue_: 'Continue',
...
LOCALES.es = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 ¡Ganaste!', youLose: 'Derrota', changePortrait: 'Cambiar retrato', rolePartner: 'Compañero', lastTrick: 'Última baza', dealerChip: 'Reparte', suggested: 'Sugerida', houseRules: 'Reglas de la casa', hrNil: 'Nulo', hrBlindNil: 'Nulo Ciego', hrBoard: 'Mínimo 4', hrJokers: 'Comodines y Doses', hrFloor: 'Pierde en {n}', hrNoFloor: 'Sin límite de derrota', ai_easy: 'IA fácil', ai_medium: 'IA media', ai_hard: 'IA difícil', feedback: '💬 Opiniones', fxTrump: '¡Fallo con espada!', fxStreak: 'Racha', fxOvertrump: '¡Contrafallo!', fxAceSpades: '¡As de Espadas!', fxBigJoker: '¡Comodín Grande!', fxLittleJoker: '¡Comodín Pequeño!', boardNote: 'Tu equipo debe apostar al menos {n}', roleOpponent: 'Rival', roleRival: 'Rival', wins: 'Victorias', close: 'Cerrar', continue_: 'Continuar',
...
LOCALES.ar = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 فزت!', youLose: 'هزيمة', changePortrait: 'تغيير الصورة', rolePartner: 'شريك', lastTrick: 'آخر أكلة', dealerChip: 'الموزّع', suggested: 'مقترح', houseRules: 'قواعد الطاولة', hrNil: 'صفر', hrBlindNil: 'صفر أعمى', hrBoard: 'حد أدنى 4', hrJokers: 'الجوكر والدواسي', hrFloor: 'الخسارة عند {n}', hrNoFloor: 'بلا حد للخسارة', ai_easy: 'ذكاء سهل', ai_medium: 'ذكاء متوسط', ai_hard: 'ذكاء صعب', feedback: '💬 رأيك', fxTrump: 'قطع بالحكم!', fxStreak: 'متتالية', fxOvertrump: 'قطع أعلى!', fxAceSpades: 'آص البستوني!', fxBigJoker: 'الجوكر الكبير!', fxLittleJoker: 'الجوكر الصغير!', boardNote: 'على فريقك أن يزايد {n} على الأقل', roleOpponent: 'خصم', roleRival: 'منافس', wins: 'انتصارات', close: 'إغلاق', continue_: 'متابعة',
...
LOCALES.zh = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 你赢了！', youLose: '失败', changePortrait: '更换头像', rolePartner: '搭档', lastTrick: '上一墩', dealerChip: '庄家', suggested: '建议', houseRules: '房规', hrNil: '零叫', hrBlindNil: '盲零', hrBoard: '最少4墩', hrJokers: '大小王与2', hrFloor: '{n}分判负', hrNoFloor: '无负分下限', ai_easy: '简单AI', ai_medium: '中等AI', ai_hard: '困难AI', feedback: '💬 反馈', fxTrump: '将吃！', fxStreak: '连胜', fxOvertrump: '超吃！', fxAceSpades: '黑桃A！', fxBigJoker: '大王！', fxLittleJoker: '小王！', boardNote: '你方至少要叫{n}墩', roleOpponent: '对手', roleRival: '对手', wins: '胜', close: '关闭', continue_: '继续',
