...
LOCALES.en = {
  ...
  ui: {
    ...
    youWin: '🏆 You Win!', youLose: 'Defeat', changePortrait: 'Change portrait', rolePartner: 'Partner', lastTrick: 'Last trick', dealerChip: 'Dealer', suggested: 'Suggested', houseRules: 'House Rules', hrNil: 'Nil', hrBlindNil: 'Blind Nil', hrBoard: 'Board of 4', hrJokers: 'Jokers & Deuces', hrFloor: 'Lose at {n}', hrNoFloor: 'No losing floor', ai_easy: 'Easy AI', ai_medium: 'Medium AI', ai_hard: 'Hard AI', boardNote: 'Your team must bid at least {n}', roleOpponent: 'Opponent', roleRival: 'Rival', wins: 'Wins', close: 'Close', continue_: 'Continue',
...
LOCALES.es = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 ¡Ganaste!', youLose: 'Derrota', changePortrait: 'Cambiar retrato', rolePartner: 'Compañero', lastTrick: 'Última baza', dealerChip: 'Reparte', suggested: 'Sugerida', houseRules: 'Reglas de la casa', hrNil: 'Nulo', hrBlindNil: 'Nulo Ciego', hrBoard: 'Mínimo 4', hrJokers: 'Comodines y Doses', hrFloor: 'Pierde en {n}', hrNoFloor: 'Sin límite de derrota', ai_easy: 'IA fácil', ai_medium: 'IA media', ai_hard: 'IA difícil', boardNote: 'Tu equipo debe apostar al menos {n}', roleOpponent: 'Rival', roleRival: 'Rival', wins: 'Victorias', close: 'Cerrar', continue_: 'Continuar',
