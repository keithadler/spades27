...
LOCALES.en = {
  ...
  ui: {
    ...
    bidBubble: 'Bid {n}', firstTrick: 'FIRST TRICK', points: 'points',
...
LOCALES.es = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    bidBubble: 'Apuesta {n}', firstTrick: 'PRIMERA BAZA', points: 'puntos',
...
LOCALES.ar = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    bidBubble: 'مزايدة {n}', firstTrick: 'الأكلة الأولى', points: 'نقطة',
...
LOCALES.zh = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    bidBubble: '叫牌 {n}', firstTrick: '首墩', points: '分',
