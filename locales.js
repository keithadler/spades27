...
LOCALES.ar = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 فزت!', youLose: 'هزيمة', changePortrait: 'تغيير الصورة', rolePartner: 'شريك', lastTrick: 'آخر أكلة', dealerChip: 'الموزّع', suggested: 'مقترح', houseRules: 'قواعد الطاولة', hrNil: 'صفر', hrBlindNil: 'صفر أعمى', hrBoard: 'حد أدنى 4', hrJokers: 'الجوكر والدواسي', boardNote: 'على فريقك أن يزايد {n} على الأقل', roleOpponent: 'خصم', roleRival: 'منافس', wins: 'انتصارات', close: 'إغلاق', continue_: 'متابعة',
...
LOCALES.zh = {
  ...
  ui: Object.assign({}, (function(){ const b = {}; for (const k in LOCALES.en.ui) b[k] = LOCALES.en.ui[k]; return b; })(), {
    ...
    youWin: '🏆 你赢了！', youLose: '失败', changePortrait: '更换头像', rolePartner: '搭档', lastTrick: '上一墩', dealerChip: '庄家', suggested: '建议', houseRules: '房规', hrNil: '零叫', hrBlindNil: '盲零', hrBoard: '最少4墩', hrJokers: '大小王与2', boardNote: '你方至少要叫{n}墩', roleOpponent: '对手', roleRival: '对手', wins: '胜', close: '关闭', continue_: '继续',
